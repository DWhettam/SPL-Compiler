...
- Strongly typed
	- SPL will not allow any mixing of types, with 2 exceptions. The exceptions are as follows:
		- Addition and subtratction between INTEGER's and REAL's
...
- Variables cannot be declard within a FOR loop, implicitly or explicitly
